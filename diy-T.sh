...
#名称修改
sed -i 's/TVBox/taka版TVBOX/g' $CURRENT_DIR/$DIR/app/src/main/res/values-zh/strings.xml
sed -i 's/TVBox/taka版TVbox/g' $CURRENT_DIR/$DIR/app/src/main/res/values/strings.xml
#图标修改
